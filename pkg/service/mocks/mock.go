...
import (
	...
	to_do_list "github.com/Mobo140/projects/to_do_list"
...
func (m *MockAuthorization) CreateUser(user to_do_list.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Create(userId int, list to_do_list.TodoList) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) GetAll(userId int) ([]to_do_list.TodoList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId)
	ret0, _ := ret[0].([]to_do_list.TodoList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTodoList) GetById(userId, listId int) (to_do_list.TodoList, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input to_do_list.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item to_do_list.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockTodoItem) GetAll(userId, listId int) ([]to_do_list.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId, listId)
	ret0, _ := ret[0].([]to_do_list.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetById mocks base method.
func (m *MockTodoItem) GetById(userId, itemId int) (to_do_list.TodoItem, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input to_do_list.UpdateItemInput) error {
	m.ctrl.T.Helper()
